...
public class TalonMecanumDrive extends RobotDriveBase implements Sendable, AutoCloseable {
  ...
  public void driveCartesian(double ySpeed, double xSpeed, double zRotation, double gyroAngle) {
    ...
    m_frontLeftMotor.set(ControlMode.PercentOutput, speeds.frontLeft * m_maxOutput);
    m_frontRightMotor.set(ControlMode.PercentOutput, speeds.frontRight * m_maxOutput);
    m_rearLeftMotor.set(ControlMode.PercentOutput, speeds.rearLeft * m_maxOutput);
    m_rearRightMotor.set(ControlMode.PercentOutput, speeds.rearRight * m_maxOutput);
